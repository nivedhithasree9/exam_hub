...
ADDITIONAL_EXAMS = [
    exam_record(
        ...
        ["Apply with selected subjects", "Appear for CUET UG", "Download score card", "Apply through university portals"],
        "February / March",
        "May / June",
    ...
    exam_record(
        ...
        ["Register for paper codes", "Appear for CUET PG", "Use score in university counselling"],
        "December / January",
        "March / April",
    ...
    exam_record(
        ...
        ["Apply online", "Book test slot", "Appear for BITSAT", "Submit preference form", "Participate in iterations"],
        "January / February",
        "May / June",
        "3 hours",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["Apply online", "Appear for CET", "Check score", "Participate in CAP counselling"],
        "January",
        "April / May",
    ...
    exam_record(
        ...
        ["Apply online", "Appear for KCET", "Verify documents", "Participate in seat allotment"],
        "January / February",
        "April / May",
    ...
    exam_record(
        ...
        ["Apply online", "Appear for Paper I and II", "Check result", "Use certificate/score as applicable"],
        "March / September",
        "June / December",
        "3 hours",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["Child development", "Language I", "Language II", "Mathematics", "Environmental Studies / subject pedagogy"],
        ...
        ["Apply online", "Appear for selected paper", "Download certificate after qualifying"],
        "Varies",
    ...
    exam_record(
        ...
        ["Apply through UPSC", "Written exam", "SSB interview", "Medical test", "Final merit"],
        "December / May",
        "April / September",
        "Two written papers",
    ...
    exam_record(
        ...
        ["Verbal ability", "Numerical ability", "Reasoning", "General awareness", "Military aptitude"],
        ...
        ["Apply online", "Appear for AFCAT", "AFSB interview", "Medical examination", "Final merit"],
        "June / December",
        "February / August",
        "2 hours",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["Preliminary exam", "Main exam", "Personality test", "Medical exam", "Final merit"],
        "September",
        "February / June",
        "Multiple papers",
        "Offline written exam",
    ...
    exam_record(
        ...
        ["Written exam", "Physical tests", "Medical examination", "Interview", "Final merit"],
        "April",
        "August",
        "Two written papers",
        "Offline written exam",
    ...
    exam_record(
        ...
        ["Tier I", "Tier II", "Skill/typing test where applicable", "Document verification"],
        "April",
        "July / August",
        "Varies by tier",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["CBT 1", "CBT 2", "Skill/aptitude test where applicable", "Document verification", "Medical exam"],
        "As notified by RRB",
        "As notified by RRB",
        "Varies by stage",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["Mathematics", "Reasoning", "General science", "Basic science and engineering", "Trade knowledge"],
        "Computer-based stages plus computer-based aptitude test for ALP.",
        "Railway Recruitment Boards",
        "https://www.rrbcdg.gov.in",
        "Assistant Loco Pilot and related railway technical posts.",
        ["CBT 1", "CBT 2", "Aptitude test for ALP", "Document verification", "Medical exam"],
        "As notified by RRB",
        "As notified by RRB",
        "Varies by stage",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["Reasoning", "Data interpretation", "English", "General/economy/banking awareness"],
    ...
    exam_record(
        ...
        ["Preliminary exam", "Main exam", "Language proficiency test if applicable", "Final merit"],
        "As notified by SBI",
        "As notified by SBI",
        "Varies by stage",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["Reasoning", "Numerical ability", "English", "General/financial awareness", "Computer aptitude"],
    ...
    exam_record(
        ...
        ["Reasoning", "Quantitative aptitude", "Computer knowledge", "General awareness", "Language"],
        "Prelims, Mains/single exam, and interview for officer posts as applicable.",
        "Institute of Banking Personnel Selection",
        "https://www.ibps.in",
        "Recruitment in Regional Rural Banks.",
        ["Prelims where applicable", "Mains/single exam", "Interview for officers", "Allotment"],
        "June",
        "August / September",
        "Varies by post",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["General awareness", "Quantitative aptitude", "Reasoning", "English", "Economic and social issues", "Finance and management"],
    ...
    exam_record(
        ...
        ["Reasoning", "Numerical ability", "English", "General awareness", "Computer knowledge"],
        "Prelims, Mains, and language proficiency test.",
        "Reserve Bank of India",
        "https://opportunities.rbi.org.in",
        "Assistant posts in RBI.",
        ["Preliminary exam", "Main exam", "Language proficiency test", "Final selection"],
        "As notified by RBI",
        "As notified by RBI",
        "Varies by stage",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["Apply online", "Appear for NEET PG", "Check rank", "Participate in counselling"],
    ...
    exam_record(
        ...
        ["Pharmaceutics", "Pharmaceutical chemistry", "Pharmacology", "Pharmacognosy", "Pharmaceutical analysis"],
        "Computer-based objective exam.",
        "National Board of Examinations in Medical Sciences",
        "https://natboard.edu.in",
    ...
    exam_record(
        ...
        ["Verbal ability", "Decision making", "Quantitative aptitude", "Data interpretation", "General knowledge"],
        ...
        ["Register for XAT", "Appear for exam", "Institute shortlisting", "Interview/admission rounds"],
        "July / August",
        "January",
        "About 3 hours",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["Quantitative techniques", "Logical reasoning", "Language comprehension", "General awareness", "Innovation and entrepreneurship"],
        "Computer-based objective test.",
        "National Testing Agency (NTA)",
        "https://exams.nta.ac.in/CMAT/",
        "Admission to management programs in CMAT-accepting institutes.",
        ["Apply online", "Appear for CMAT", "Use score for institute admission process"],
        "March / April",
        "May",
        "3 hours",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["General English", "Analytical and logical reasoning", "Quantitative and data interpretation"],
        "Computer-based objective test.",
        "Symbiosis International University",
        "https://www.snaptest.org",
        "MBA admission in Symbiosis institutes.",
        ["Register for SNAP", "Appear for test", "Apply to institutes", "GE-PI-WAT/admission rounds"],
        "August",
        "December",
        "1 hour",
        "Computer-based test",
    ...
    exam_record(
        ...
        ["Constitutional law", "Jurisprudence", "Criminal law", "Contract law", "Torts", "Current legal developments"],
        ...
        ["Apply online", "Appear for CLAT PG", "Check rank", "Participate in counselling"],
        "July",
        "December",
        "2 hours",
        "Offline pen-and-paper test",
    ...
    exam_record(
        ...
        ["English", "Current affairs", "Logical reasoning", "Legal reasoning for PG/advanced law topics where applicable"],
        ...
        ["Apply online", "Appear for AILET", "Check merit", "Complete counselling/admission"],
        "August",
        "December",
        "Varies by program",
        "Offline pen-and-paper test",
    ...
    exam_record(
        ...
        ["General ability", "Creative ability", "Situation test / studio test where applicable"],
        ...
        ["Apply online", "Appear for written tests", "Attend situation test/interview where applicable", "Counselling"],
        "December",
        "February",
        "Varies by test",
    ...
    exam_record(
        ...
        ["Visualization", "Observation", "Design sensitivity", "Analytical reasoning", "Drawing"],
        ...
        ["Apply online", "Appear for UCEED", "Check rank", "Apply for B.Des counselling"],
        "October",
        "January",
        "3 hours",
    ...
    exam_record(
        ...
        ["Drawing and composition", "Visual reasoning", "Mathematics", "Architecture aptitude"],
    ...
    exam_record(
        ...
        ["Register with ICAI", "Complete study period", "Apply for exam", "Pass papers to move to Intermediate"],
    ...
    exam_record(
        ...
        ["Fundamentals of economics", "Accounting", "Laws and ethics", "Business mathematics and statistics"],
        "Foundation-level papers as notified by ICMAI.",
        "Institute of Cost Accountants of India",
        "https://icmai.in",
        "Entry into the CMA professional course pathway.",
        ["Register with ICMAI", "Complete required study period", "Apply for exam", "Pass to move to Intermediate"],
    ...
    exam_record(
        ...
        ["Business communication", "Legal aptitude", "Economic and business environment", "Current affairs"],
        "Remote/online objective test as notified.",
        "Institute of Company Secretaries of India",
        "https://www.icsi.edu",
        "Entry route to CS Executive Programme.",
        ["Register with ICSI", "Appear for CSEET", "Move to Executive Programme after qualifying"],
        "Multiple windows",
        "Multiple windows",
        "2 hours",
        "Online as notified",
